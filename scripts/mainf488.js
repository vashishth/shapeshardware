...
if(days==1){$("#days").html(days+"<span>Day</span>");}
else if(days>0){$("#days").html(days+"<span>Days</span>");}else{$('#days').hide()}
$("#hours").html(hours+"<span>Hours</span>");$("#minutes").html(minutes+"<span>Minutes</span>");$("#seconds").html(seconds+"<span>Seconds</span>");}